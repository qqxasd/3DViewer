...
class Command {
 public:
  Command(std::vector<GLfloat> *vertexes = nullptr, std::vector<std::vector<GLuint>> *fasets = nullptr) :
    vertexes_(vertexes),
    fasets_(fasets) {}
...
class ScaleCommand : public Command {
 public:
  ScaleCommand(std::vector<GLfloat> *vertexes, double value) : Command(vertexes), value_(value){};
  void Execute() override;
...
class ParseCommand : public Command {
 public:
  ParseCommand(std::vector<GLfloat> *vertexes, std::vector<std::vector<GLuint>> *fasets, std::string path) : Command(vertexes, fasets), path_(path){};
  void Execute() override;
